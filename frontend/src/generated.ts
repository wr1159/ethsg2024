...
export const baseSubdomainRegistrarAbi = [
  {
    type: 'event',
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    outputs: [
      {
        name: 'pricer',
        internalType: 'contract ISubdomainPricer',
        type: 'address',
      },
  ...
  },
  {
    ...
    name: 'wrapper',
    outputs: [
      { name: '', internalType: 'contract INameWrapper', type: 'address' },
    ],
    stateMutability: 'view',
  },
] as const
...
export const coinmunityAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'priceIncrement', internalType: 'uint256', type: 'uint256' },
      { name: '_nftExchangeRate', internalType: 'uint256', type: 'uint256' },
      { name: 'ens', internalType: 'contract ENS', type: 'address' },
      { name: 'reverseRegistrar', internalType: 'address', type: 'address' },
      { name: 'publicResolver', internalType: 'address', type: 'address' },
    ],
    name: 'launch',
    outputs: [],
    stateMutability: 'nonpayable',
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ContinuousLinearToken
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

export const continuousLinearTokenAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_name', internalType: 'string', type: 'string' },
      { name: '_symbol', internalType: 'string', type: 'string' },
      { name: '_slope', internalType: 'uint256', type: 'uint256' },
      { name: '_initialPrice', internalType: 'uint256', type: 'uint256' },
      { name: '_maxPlugins', internalType: 'uint256', type: 'uint256' },
      { name: '_pluginCallGasLimit', internalType: 'uint256', type: 'uint256' },
  ...
  { type: 'error', inputs: [], name: 'IndexOutOfBounds' },
  { type: 'error', inputs: [], name: 'InsufficientPaymentAmount' },
  { type: 'error', inputs: [], name: 'InvalidPluginAddress' },
  { type: 'error', inputs: [], name: 'InvalidTokenInPlugin' },
  { type: 'error', inputs: [], name: 'OutputArrayTooSmall' },
  {
    type: 'error',
  ...
  { type: 'error', inputs: [], name: 'PluginAlreadyAdded' },
  { type: 'error', inputs: [], name: 'PluginNotFound' },
  { type: 'error', inputs: [], name: 'PluginsLimitReachedForAccount' },
  { type: 'error', inputs: [], name: 'PopFromEmptyArray' },
  { type: 'error', inputs: [], name: 'ReentrantCall' },
  { type: 'error', inputs: [], name: 'SaleFailed' },
  { type: 'error', inputs: [], name: 'ZeroPluginsLimit' },
  {
    type: 'event',
    anonymous: false,
    inputs: [
...
export const delegatedShareAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'name_', internalType: 'string', type: 'string' },
      { name: 'symbol_', internalType: 'string', type: 'string' },
      { name: 'maxUserPlugins_', internalType: 'uint256', type: 'uint256' },
      { name: 'pluginCallGasLimit_', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  { type: 'error', inputs: [], name: 'ApproveDisabled' },
  {
    type: 'error',
    inputs: [
      { name: 'spender', internalType: 'address', type: 'address' },
  ...
  { type: 'error', inputs: [], name: 'InvalidPluginAddress' },
  { type: 'error', inputs: [], name: 'InvalidTokenInPlugin' },
  { type: 'error', inputs: [], name: 'NotOwnerPlugin' },
  { type: 'error', inputs: [], name: 'OutputArrayTooSmall' },
  { type: 'error', inputs: [], name: 'PluginAlreadyAdded' },
  { type: 'error', inputs: [], name: 'PluginNotFound' },
  { type: 'error', inputs: [], name: 'PluginsLimitReachedForAccount' },
...
export const delegationPluginAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'name_', internalType: 'string', type: 'string' },
  ...
  },
  {
    ...
    name: 'TOKEN',
    outputs: [
      { name: '', internalType: 'contract IERC20Plugins', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const erc721PausableAbi = [
  {
    type: 'error',
    inputs: [
      { name: 'sender', internalType: 'address', type: 'address' },
...
export const foreverSubdomainRegistrarAbi = [
  {
    type: 'constructor',
    inputs: [{ name: 'wrapper', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'error',
  ...
  { type: 'error', inputs: [], name: 'Unavailable' },
  {
    type: 'event',
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'records', internalType: 'bytes[]', type: 'bytes[]' },
    ],
    name: 'register',
    outputs: [],
    stateMutability: 'payable',
...
export const iBaseRegistrarAbi = [
  {
    type: 'event',
    anonymous: false,
    inputs: [
...
export const iDelegatedShareAbi = [
  { type: 'error', inputs: [], name: 'InvalidPluginAddress' },
  { type: 'error', inputs: [], name: 'InvalidTokenInPlugin' },
  { type: 'error', inputs: [], name: 'PluginAlreadyAdded' },
  { type: 'error', inputs: [], name: 'PluginNotFound' },
  ...
  },
  {
    ...
    name: 'MAX_PLUGINS_PER_ACCOUNT',
    outputs: [
      { name: 'pluginsLimit', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'hasPlugin',
    outputs: [{ name: 'hasPlugin', internalType: 'bool', type: 'bool' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    name: 'pluginAt',
    outputs: [{ name: 'plugin', internalType: 'address', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    name: 'plugins',
    outputs: [
      { name: 'plugins', internalType: 'address[]', type: 'address[]' },
    ],
    stateMutability: 'view',
  },
  {
...
export const iDelegationPluginAbi = [
  {
    type: 'event',
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    name: 'delegated',
    outputs: [{ name: 'delegatee', internalType: 'address', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
...
export const iForeverSubdomainRegistrarAbi = [
  {
    type: 'function',
    inputs: [{ name: 'node', internalType: 'bytes32', type: 'bytes32' }],
    name: 'available',
...
export const iMetadataServiceAbi = [
  {
    type: 'function',
...
export const iNameWrapperAbi = [
  ...
  },
  {
    ...
    outputs: [
      { name: '', internalType: 'contract IMetadataService', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { name: 'registrarExpiry', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'registrar',
    outputs: [
      { name: '', internalType: 'contract IBaseRegistrar', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
    type: 'function',
    inputs: [
      { name: 'labelHash', internalType: 'uint256', type: 'uint256' },
      { name: 'duration', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'renew',
  ...
  },
  {
    ...
    name: 'setFuses',
    outputs: [{ name: 'newFuses', internalType: 'uint32', type: 'uint32' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      { name: 'label', internalType: 'bytes32', type: 'bytes32' },
      { name: 'newRegistrant', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    name: 'wrapETH2LD',
    outputs: [{ name: 'expires', internalType: 'uint64', type: 'uint64' }],
    stateMutability: 'nonpayable',
  },
] as const
...
export const iNameWrapperUpgradeAbi = [
  {
    type: 'function',
    inputs: [
      { name: 'name', internalType: 'bytes', type: 'bytes' },
...
export const iRentalSubdomainRegistrarAbi = [
  {
    type: 'function',
    inputs: [{ name: 'node', internalType: 'bytes32', type: 'bytes32' }],
    name: 'available',
  ...
  },
  {
    ...
    name: 'renew',
    outputs: [{ name: 'newExpiry', internalType: 'uint64', type: 'uint64' }],
    stateMutability: 'payable',
  },
  {
    type: 'function',
...
export const iReverseRegistrarAbi = [
  {
    type: 'function',
    inputs: [{ name: 'owner', internalType: 'address', type: 'address' }],
    name: 'claim',
...
export const iSubdomainPricerAbi = [
  {
    type: 'function',
    inputs: [
      { name: 'parentNode', internalType: 'bytes32', type: 'bytes32' },
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ITokenizedDelegationPlugin
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

export const iTokenizedDelegationPluginAbi = [
  {
    type: 'event',
    anonymous: false,
    inputs: [
...
export const reentrancyGuardLibAbi = [
  { type: 'error', inputs: [], name: 'ReentrantCall' },
] as const
...
export const rentalSubdomainRegistrarAbi = [
  {
    type: 'constructor',
    inputs: [{ name: 'wrapper', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  ...
  { type: 'error', inputs: [], name: 'DataMissing' },
  {
    type: 'error',
    inputs: [{ name: 'node', internalType: 'bytes32', type: 'bytes32' }],
    name: 'DurationTooLong',
  ...
  { type: 'error', inputs: [], name: 'FailedInnerCall' },
  { type: 'error', inputs: [], name: 'NameNotRegistered' },
  {
    type: 'error',
    inputs: [{ name: 'node', internalType: 'bytes32', type: 'bytes32' }],
    name: 'ParentExpired',
...
export const reverseClaimerAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'ens', internalType: 'contract ENS', type: 'address' },
...
export const tokenizedDelegationPluginAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'name_', internalType: 'string', type: 'string' },
      ...
      { name: 'maxSharePlugins_', internalType: 'uint256', type: 'uint256' },
      {
        name: 'sharePluginGasLimit_',
        internalType: 'uint256',
        type: 'uint256',
      },
    ],
  ...
  { type: 'error', inputs: [], name: 'NotRegisteredDelegatee' },
  { type: 'error', inputs: [], name: 'TransferDisabled' },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    ...
    name: 'registration',
    outputs: [
      { name: '', internalType: 'contract IDelegatedShare', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
